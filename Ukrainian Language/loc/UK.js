AddLanguage('UK','ukrainian',{
	...
	"Don't show this again": "Не показувати знову",
	...
	"Click": "Клац",
	"Shift": "/",
	"Shift-click": "Shift-клац",
	"Ctrl": "/",
	"Ctrl-click": "Ctrl-клац",
	"Esc": "/",
	"Cookies": "Печива",
	"%1 day": [ 
		"%1 дн.",
	...
	"less than 1 second": "меньше 1 сек.",
	"in %1": "через %1",
	"%1 ago": "%1 тому",
	...
	"a long while": "давним давно",
	"forever": "назавжди",
	"Time remaining:": "Залишилося часу:",
	"Big clickable cookie": "Велике печиво по центру",
	"Golden cookie": "Золоте печиво",
	"Wrath cookie": "Злісне печиво",
	"Reindeer": "Олень",
	"Options": "Налаштування",
	"General": "Загальні",
	"Settings": "Налаштування",
	"Volume": "Гучність",
	"Volume (music)": "Гучніть музики",
	"ON": "Вмк",
	"OFF": "Вимк",
	"Fancy graphics": "Фантастична графіка",
	"CSS filters": "Фільтри CSS",
	"visual improvements; disabling may improve performance": "покращує графіку; відключення може підвищити продуктивність",
	"Particles": "Частинки",
	"Numbers": "Цифри",
	"numbers that pop up when clicking the cookie": "цифри які з'являються під час клацання по печиву",
	"Milk [setting]": "Молоко",
	"Cursors [setting]": "Курсори",
	"visual display of your cursors": "Відображає всі ваші курсори на екрані",
	"Wobbly cookie": "Вихлясте печиво",
	"Alt cookie sound": "Альтернативні звуки печива",
	"Icon crates": "Коробки для іконок",
	"display boxes around upgrades and achievements in Stats": "Відображає коробки навколо покращень та досягнень у Статистиці",
	"Alt font": "Альтернативний шрифт",
	"your cookies are displayed using a monospace font": "ваші печива відображатимуся за допомогою моноширного шрифта",
	"Short numbers": "Короткі цифри",
	"Fast notes": "Швидкі сповіщення",
	"notifications disappear much faster": "сповіщення пропадають набагато швидше",
	"Closing warning": "Попередження перед закриттям програми",
	"the game will ask you to confirm when you close the window": "перед закриттям гри з'явиться віконце для підтвердження виходу",
	"Defocus": "Дефокус",
	"the game will be less resource-intensive when out of focus": "гра буде менш ресурсозатратної якщо її вікно не у фокусі",
	"Extra buttons": "додаткові кнопки",
	"add options on buildings like Mute": "додає нові можливості для керування будівлявими, наприклад Закрити",
	"Lump confirmation": "Підтвердження для шматків",
	"the game will ask you to confirm before spending sugar lumps": "перед використанням шматочків цукру, з'явиться віконце для підтвердження",
	"Custom grandmas": "Особливі бабусі",
	"some grandmas will be named after Patreon supporters": "деякі бабусі матимуть ім'я в честь підписників Patreon",
	"Scary stuff": "Лячні речі",
	"Sleep mode timeout": "Режим сну",
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode": "для повільних комп'ютерів, гра перейде у режим сну, якщо вона неактивна або починає відставати; під час режиму сну вмикається режим офлайн ПзС",
	"Music in background": "Музика на фоні",
	"music will keep playing even when the game window isn't focused": "Музика продовжуватиме грати навіть якщо вікно гри не у фокусі",
	"Cloud saving": "Хмарне збереження",
	"allow use of Steam Cloud for save backups": "дозволяє грі використовувати Steam Cloud для збережень",
	"Purge Cloud": "Очистити хмару",
	"Current Cloud use:": "Використання пам'яті в хмарі",
	"No Cloud access at the moment.": "Немає доступу до хмари",
	"Screen reader mode": "Режим зчитування з екрана",
	"allows optimizations for screen readers; game will reload": "дозволяє оптимізацію для зчитувачів тексту; гру буде перезапущено",
	"Discord status": "Статус в Discord",
	"if Discord is on, show your game info as activity status": "якщо Discord увімкненний, у статусі активності буде відображатися ваш прогрес у грі",
	"Language": "Мова",
	"Language: %1": "Мова: %1",
	"Change language": "Змінити мову",
	"note: this will save and reload your game": "застереження: ця дія перезапустить та збереже вашу гру",
	"Press %1 to toggle fullscreen.": "Натисніть %1, щоб увійти у повноекранний режим",
	"Other versions": "Інші версії",
	"Beta": "Бета",
	"Stats": "Статистика",
	"Shadow achievements": "Тіньові досягнення",
	"These are feats that are either unfair or difficult to attain. They do not give milk.": "Ці подвиги зовсім нечестні або складні для отримання. Вони не додають молока",
	"starter milk": "початкове молоко",
	"for %1 achievements": "за %1 досягнень",
	"appeased": "заспокоєні",
	"awoken": "пробуджені",
	"displeased": "незадоволені",
	"angered": "розлючені",
	"Cookies in bank:": "Печива у банку",
	"Cookies baked (this ascension):": "Печива спечино (за це сходження)",
	"Cookies baked (all time):": "Печива спечино (за весь час)",
	"Cookies forfeited by ascending:": "Печива втрачено",
	"Legacy started:": "Спадщину розпочато:",
	"with %1 ascension": [
		"за %1 сходження",
		"за %1 сходжень"
	],
	"Run started:": "Забіг розпочато:",
	"Buildings owned:": "Будівель:",
	"Cookies per second:": "Печива за секунду:",
	"Raw cookies per second:": "Сухі печива за секунду:",
	"highest this ascension:": "Найбільше за це сходження:",
	"multiplier:": "множник:",
	"withered:": "засохлі:",
	"Cookies per click:": "Печива за клацання",
	"Cookie clicks:": "Клацань на печиво",
	"Hand-made cookies:": "Виготовлені в ручну печива",
	"Golden cookie clicks:": "Клацань по золотих печивах",
	"Random drop multiplier:": "Множник випадкових подій",
	"all time:": "за весь час:",
	"Running version:": "Поточна версія",
	"Special": "Особливі",
	"Challenge mode:": "Режим випробувань:",
	"Seasonal event:": "Сезонна подія:",
	"Research:": "Дослідження:",
	"Grandmatriarchs status:": "Статус бабусетріарху",
	"Pledge:": "Застава:",
	"Wrinklers popped:": "зморщинників лопнуто:",
	"Sugar lumps harvested:": "Шматочків цукру зібрано:",
	"Reindeer found:": "Оленів знайдено",
	"Santa stages unlocked:": "Стадій санти розблоковано:",
	"Dragon training:": "Тренування дракона:",
	"Prestige": "Престиж",
	"at %1% of its potential <b>(+%2% CpS)</b>": "за %1% потенціалу <b>(+%2% ПзС)</b>",
	"Prestige upgrades unlocked:": "Покращень престижу розбоковано:",
	"Upgrades unlocked:": "Покращень придбано:",
	"Achievements unlocked:": "Досягнень отримано:",
	"Kitten multiplier:": "Множник від кошенят:",
	"Milk": "Молоко",
	"Milk:": "Молока:",
	"Milk flavors unlocked:": "Смаків молока розблоковано",
	"Milk is gained with each achievement. It can unlock unique upgrades over time.": "Ви отримуюте молоко з кожним новим досягненням. Воно розблоковує нові покращення з часом",
	"Rank %1": "Ранг %1",
	...
	"Sanguine milk": "Криваво-червоне молоко",
	"Midas milk": "Мідасове молоко",
	"Midnight milk": "Сяюче молоко",
	"Green inferno milk": "Зелено-полум'яне молоко",
	"Frostfire milk": "Морозно-вогняне молоко",
	"Honey milk": "Молоко з медом",
	"Coffee milk": "Молоко з кавою",
	"Tea milk": "Молоко з чаєм",
	...
	"Hazelnut milk": "Горіхове молоко",
	"Info": "Інформація",
	"About": "Про гру",
	"Cookie Clicker is a javascript game by %1 and %2.": "Cookie Clicker це гра написана на мові javascript від %1 та %2.",
	"Music by %1.": "Музика від %1.",
	"Useful links: %1, %2, %3, %4.": "Корисні посилання:%1, %2, %3, %4.",
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1": "Ця версія Cookie Clicker абсолютно безкоштовна, назавжди. Бажаєте підтримати нас, щоб ми могли продовжувати розроблювати ігри? Ось декілька способів, як ви можете нам допомогти:%1",
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!": "Застереження: якщо ви знайдете якусь хибу після оновлення, і ви використовуєте стороннє доповнення, переконайтеся що проблема не в доповнені!",
	"Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!": "Попередження: очищення кешу сайту або файлів cookies <small>(хто б міг подумати?)</small> призвиде до видалення вашого збереження, експортуйте свій файл збереження перед очищенням!",
	"Version history": "Історія версій",
	"Official website": "Офіційний вебсайт",
	"Note: links will open in your web browser.": "Застереження: посилання відкриватися у вашому веббраузері",
	"Note: older update notes are in English.": "Застереження: старі нотатки в історії оновлень написані англійською мовою",
	"This feature is not yet available in your language.": "Ця функція поки що не доступна вашою мовою",
	"Restart with new changes": "Перезапустити з новими змінами",
	"Cookie Clicker is in sleep mode.": "Cookie Clicker у режимі сну",
	"Cookie Clicker is in sleep mode and generating offline cookies.": "Cookie Clicker у режимі сну та генерує печиво в офлайн режимі",
	"%1 to resume from your save file.": "%1, щоб продовжити з вашого файлу збереження",
	"(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)": "(це стається коли надто багато кадрів пропускаються за раз,<br>зазвичай, після того як гра працювала на фоні деякий час)<br>(ви можете вимкнути цю функцію в меню налаштувань)",
	"Are you sure you want to close Cookie Clicker?": "Ви впевнені, що хочете закрити Cookie Clicker?",
	"Back up your save!": "Створіть резервну копію вашого файлу збереження!",
	"Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit \"Export save\" or \"Save to file\"!": "Знову привіт! Просто нагадую, якщо ви хочете час від часу створювати резервні копії файлів збереження Cookie Clicker, про всяк випадок.<br>Ви можете перейти до налаштувань та натиснути \"Експортувати збереження\" або \"Зберегти файл\"!",
	"Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)": "Зберегіння вручну (Гра робить автозбереження кожні 60 секунд; Комбінація: ctrl+S)",
	"You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)": "Ви можете використати цю резервну копію, для перенесення збереження на інший комп'ютер (комбінація клавіш для імпорту: ctrl+O)",
	"Save to file": "Зберегти файл",
	"Load from file": "Завантажити з файлу",
	"Use this to keep backups on your computer": "Використовуйте це щоб зберегти резервну копію на ваш комп'ютер",
	"Export save": "Експортувати збереження",
	"Export": "Експорт",
	"This is your save code.<br>Copy it and keep it somewhere safe!": "Це код вашого збереження.<br>Скопіюйте його та зберігайте у надійному місці!",
	"Import save": "Імпортувати збереження",
	"Import": "Імпорт",
	"Please paste in the code that was given to you on save export.": "Вставте ваш код, який ви отримали під час експорту збереження",
	"Game saved": "Гру збережено",
	"Game loaded": "Гру завантажено",
	"Error while saving": "Помилка збереження",
	"Export your save instead!": "Експортуйте збереження!",
	"Error importing save": "Помилка імпорту збереження",
	"Oops, looks like the import string is all wrong!": "Ой-йой, схоже що рядок імпорту зовсім неправильний!",
	"You are attempting to load a save from a future version (v. %1; you are using v. %2).": "Ви намагаєтесь завантажити збереження з іншої версії (v. %1; ви використовуєте v. %2).",
	"Sorry, you can't import saves from the classic version.": "На жаль, ви не можете імпортувати збереження з класичної версії.",
	"Wipe save": "Стерти збереження",
	"Delete all your progress, including your achievements": "Видаляє весь ваш прогрес, в тому числі ваші досягнення",
	"Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>": "Ви СПРАВДІ хочете стерти ваше збереження?<br><small>ви втратите весь ваш прогрес, ваші досягнення, та ваші небесні крихти!</small>",
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>": "Ух ти, ви справді, <b><i>СПРАВДІ</i></b> що хочете це зробити?<br><small>І навіть не кажіть що ми вас не попередили!</small>",
	"Game reset": "Гру перезапущено",
	"Good bye, cookies.": "Прощавайте, печива.",
	"Welcome back!": "З поверненням!",
	"You earned <b>%1</b> while you were away.": "Ви отримали <b>%1</b> поки вас не було.",
	"Mods": "Моди",
	"Manage mods": "Керування модами",
	"Publish mods": "Публікація модів",
	"Update published mods": "Оновити опубліковані моди",
	"Only use mods from trusted sources. Some mods may require a game restart to take effect.": "Встановлюйте модифікації лише з перевірених ресурсів. Для роботи деяків модів потрібно перезапустити гру.",
	"Enable": "Підключити",
	"Disable": "Відключити",
	"Priority up": "Підвищити пріорітет",
	"Priority down": "Знизити пріорітет",
	"New mod": "Новий мод",
	"Select folder": "Обрати папку",
	"Select updated folder": "Обрати оновлену папку",
	"Select a mod.": "Обрати мод.",
	"Open folder": "Відкрити папку",
	"Open Workshop": "Відкрити майстерню",
	"Open Workshop page": "Відкрити сторінку майстерні",
	"Unsubscribe": "Відписатися",
	"Local mod": "Локальний мод",
	"Open %1 folder": "Відкрити %1 папку",
	"Description": "Опис",
	"Image": "Світлина",
	"Name": "Ім'я",
	"Title": "Назва",
	...
	"Publish to Workshop": "Публікувати у майстерню",
	"Version": "Версія",
	"Error!": "Помилка!",
	"none": "ні",
	...
	"Mods are loaded from top to bottom.": "Моди запускаються зверху до низу",
	"Some mods couldn't be loaded:": "Деякі моди не можна запустити:",
	"This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.": "Цей інструмент дозволяє вам публікувати модифікації до майстерні.<br>Вам потрібно обрати папку з модом де знаходиться %1 файл у правильному форматі.<br>Переглянте зразкові моди для прикладу.",
	"Mod data": "Зміст моду",
	"No mod data present.": "Зміст моду відсутній",
	"These are the mods present in your save data. You may delete some of this data to make your save file smaller.": "Ці моди знаходяться у вашому файлі збереження. Ви можете видалити деякі моди щоб зменшити розмір файлу збереження.",
	"(loaded)": "(завантажено)",
	"%1 char": [
		"%1 рядок",
		"рядків: %1"
	],
	"Check mod data": "Перевірити данні модифікації",
	"view and delete save data created by mods": "переглянути та видалити данні збереження створені модами",
	"New update!": "Нове оновлення!",
	"New version available: v. %1!": "Доступна нова версія: v. %1!",
	"Update note: \"%1\"": "Примітки оновлення: \"%1\"",
	"Refresh to get it!": "Оновіть, щоб отримати!",
	...
	"Business day": "День бізнесу",
	"Easter": "Великдень",
	"Halloween": "Геловін",
	"%1 has started!": "Почалося свято: %1",
	"%1 is over.": "Закінчилось свято: %1",
	"%1's bakery": "Пекарня %1",
	"Name your bakery": "Назвіть свою пекарню",
	"What should your bakery's name be?": "Як ви назвете свою пекарню?",
	...
	"bakery random name": [
		...
		"Техно-Бургер",
		"Турбо-Піца",
		"Середньовічний Дельфін",
		"Надприродня Черепаха",
		"Бандит-Танцюрист",
		"Пекар-Мутант",
		"Смачненький Бісквіт",
		"Щасливе Маленьке Кошення",
		"Летальний Макарон"
	],
	"%1, age %2": "%1, вік: %2",
	"Sugar lumps!": "Шматочки цукру!",
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!": "Оскільки ви спекли <b>мільярд печив</b> загалом, ви тепер можете отримувати <b>шматочки цукру</b>. Вони тихенько собі створюються близько верху вашого екрана, під кнопкою Статистика.<br>Ви зможете зібрати урожай як тільки вони доспіють, після чого їх можна витрати на різні штуки!",
	"A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.": "<b>шматочок цукру</b> об'єднується тут, завдяки вашим досягненням.",
	"Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.": "Ваші шматочки цукру виростуть за <b>%1</b>,<br>дозріють за <b>%2</b>,<br>та впадуть після <b>%3</b>.",
	"&bull; Sugar lumps can be harvested when mature, though if left alone beyond that point they will start ripening (increasing the chance of harvesting them) and will eventually fall and be auto-harvested after some time.<br>&bull; Sugar lumps are delicious and may be used as currency for all sorts of things.<br>&bull; Once a sugar lump is harvested, another one will start growing in its place.<br>&bull; Note that sugar lumps keep growing when the game is closed.": "&bull; Шматочки цукру можна зібрати коли вони виростуть, хоча якщо після цього залишити їх у спокої (це збільшить ймовірність їх збору) в кінці-кінців вони впадуть та будуть автоматично зібрані через деякий час.<br>&bull; Шматочки цукру неперевершені та можуть використовуватися як валюта для різних речей.<br>&bull; Як тільки шматочок цукру буде зібраний, наступний почне рости на тому ж місці.<br>&bull; Пам'ятайте, що шматочки цукру ростуть навіть тоді, коли гра закрита.",
	"This sugar lump has been exposed to time travel shenanigans and will take an excruciating <b>%1</b> to reach maturity.": "/Схоже, що цей шматочок цукру був замішанний у махінаціях з подорожами у часі і тепер він повинен чекати болісні <b>%1</b> щоб доспіти.",
	"This sugar lump is still growing and will take <b>%1</b> to reach maturity.": "Цей шматочок цукру все ще росте, йому знадобиться <b>%1</b>, аби вирости.",
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.": "Цей шматочок цукру вже виріс, та доспіє за <b>%1</b>.<br>Ви можете <b>клацнути на нього та зібрати</b>, але існує <b>50% шанс того що ви нічого не отримаєте</b>.",
	"<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.": "<b>Цей шматочок цукру доспів! Клацніть щоб зібрати.</b><br>Якщо ви нічого не зробите, він автоматично збереться за <b>%1</b>.",
	"This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.": "/",
	"This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.": "Цей шматочок цукру виріс <b>золотим</b>; зібравши його, ви отримаєте від 2 до 7 шматочків, кільсть вашого печива збільшиться вдвоє (не більше вашого прибутку в печивах за 24 години), і ви будете знаходити на 10% більше золотих печив у наступні 24 години.",
	"This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.": "Цей шматочок цукру зазнав впливу старійшин та тепер виросте <b>м'ясним</b>; зібравши його, ви отримаєте від 0 до 2 шматочків.",
	"This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.": "Цей шматочок цукру <b>карамелізований</b>, його липкість призводить до непередбачуваних речей; зібравши його, ви отримаєте від 1 до 3 шматочків та анулює таймер на використання шматочків цукру.",
	"You harvested <b>%1</b> while you were away.": "Було зібрано <b>%1</b> поки вас не було.",
	"Sugar blessing activated!": "Цукрове благословення активовано!",
	"Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.": "Ваші печива було збільшено вдоває.<br>+10% на появу золотого печива для наступних 24 годин.",
	"Sugar lump cooldowns cleared!": "Таймер використання шматочків цукру анульовано!",
	"Botched harvest!": "Невродило!",
	"Do you want to spend %1 to %2?": "Ви впевнені що хочете витратити %1 для %2",
	"Heralds": "Вісники",
	"%1 herald": [
		"%1 вісник",
		"вісників: %1 "
	],
	"Heralds couldn't be loaded. There may be an issue with our servers, or you are playing the game locally.": "Вісники не підвантажуються. Схоже, що наразі проблеми з серверами, аби ви граєте у гру локально",
	"There are no heralds at the moment. Please consider <b>donating to our Patreon</b>!": "На данний момент немає ні одного вісника. Але ви можете зробити <b>пожертву на Patreon, щоб допомогти нам</b>!",
	"selflessly inspiring a boost in production for everyone, resulting in %1.": "безкорисливо збільшуюють виробництво печива для всіх, загалом: %1",
	"+%1% cookies per second": "+%1% печив за секунду",
	"You are in a <b>Born again</b> run, and are not currently benefiting from heralds.": "Ви почали забіг у режимі <b>Реінкарнації</b>, і ви не отримуєте ніяуих переваг від вісників.",
	"You own the <b>Heralds</b> upgrade, and therefore benefit from the production boost.": "Ви володієте покращенням <b>Вісники</b>, і тепер ви маєте збільшення вашого виробництва",
	"To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.": "Щоб отримувати бонус від вісників, вам потрібне спеціальне покращення, яке ви поки що не придбали. Пізніше ви зможете відкрити його назавжди.",
	"<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.": "<b>Вісники</b> - це люди, котрі зробили пожертву на Patreon найвищого рівня, але їхня кількість обмежена до 100.<br>Кожен вісник додає +1% ПзС.<br>Вісники приносять користь усім учасникам гри, навіть якщо ви не робили пожертвувань.",
	"Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.": "Кожні %1 поточні гравці в Steam створюють <b>1 вісника</b>, аж до %2 вісників.<br>Кожен вісник додає кожному гравцю +1% ПзС.",
	"+%1!": "+%1!",
	"You found %1!": "Ви знайшли: %1!",
	"Found <b>%1</b>!": "Знайдено: <b>%1</b>!",
	"You also found <b>%1</b>!": "Ви також знайшли: <b>%1</b>!",
	"Lost %1!": "Втрачено: %1!",
	"Sweet!<br><small>Found 1 sugar lump!</small>": "Чудово!<br><small>Ви знайшли 1 шматочок цукру!</small>",
	"Lucky!": "Вдача!",
	"Ruin!": "Провал!",
	"Cookie chain over. You made %1.": "Ланцюжок печива скінчився. Ви отримали %1.",
	"Cookie chain": "Ланцюжок печива",
	"Cookie chain broken.<br><small>You made %1.</small>": "Ланцюжок печива зламано.<br><small>Ви отримали %1.</small>",
	"Cookie blab": [
		"Розсипчастість печива x3 на 60 секунд!",
		"Шоколадність x7 на 77 секунд!",
		"Еластичність тіста зменшена вдвічі на наступні 66 секунд!",
		"Блискучисть золотого печива збільшена вдвоє на 3 секунди!",
		"Світова економіка зменшена вдічі на 30 секунд!",
		"Поцілунки від бабусі у 23% скупіші на 45 секунд!",
		"Дякую, що клацнули!",
		"Вас пошили в дурні! Це була лише перевірка.",
		"Клаців на золоте печиво +1!",
		"Ваш клац було зареєстровано. Дякую, що ви з нами.",
		"Дякую! Прям в точку!",
		"Дякую. Висилаємо бригаду.",
		"Вони знають.",
		"Упс. Це було звичайне шоколадне печиво з блискучою алюмінівою обгорткою."
	],
	"Exploded a wrinkler": "Зморщинник лопнув",
	"Exploded a shiny wrinkler": "Блискучий зморщинник лопнув",
	...
	"The reindeer gives you %1.": "Олень дає вам: %1.",
	"You are also rewarded with %1!": "Ви також отримали: %1!",
	"You are granted %1.": "Ви отримали: %1.",
	"Found a present!": "Ви знайшли подарунок!",
	"You find a present which contains...": "Ви знайшли подарунок в якому знаходиться...",
	"Evolve": "Еволюціонувати",
	"Festive test tube": "Фестивальна пробірка",
	"Festive ornament": "Фестивальний орнамент",
	"Festive wreath": "Фестивальний вінок",
	"Festive tree": "Фестивальне дерево",
	"Festive present": "Фестивальний подарунок",
	"Festive elf fetus": "Фестивальний зародок ельфа",
	"Elf toddler": "Немовля ельф",
	"Elfling": "Ельфік",
	"Young elf": "Підліток ельф",
	"Bulky elf": "Кремезний ельф",
	"Nick": "Нік",
	"Santa Claus": "Санта Клаус",
	"Elder Santa": "Старійшина Санта",
	"True Santa": "Справжній Санта",
	"Final Claus": "Останній Клаус",
	"Dragon egg": "Яйце дракона",
	"Shivering dragon egg": "Тремтяче драконяче яйце",
	"Krumblor, cookie hatchling": "Крамблор, дракончик з печива",
	"Krumblor, cookie dragon": "Крамблор, дракон з печива",
	"Train %1": "Тренувати %1",
	"Aura: %1": "Аура: %1",
	"Chip it": "Розколіть його",
	"Hatch it": "Вилупіть його",
	"Bake dragon cookie": "Спечіть драконове печиво",
	"Delicious!": "Смакота!",
	"Train secondary aura": "Тренувати другорядну ауру",
	"Lets you use two dragon auras simultaneously": "Дозволяє вам використовувати 2 драконові аури одночасно",
	"Your dragon is fully trained.": "Ваш дракон повністю натренованний",
	"%1 of every building": "%1 штук кожної будівлі",
	"No aura": "Без аури",
	"Set your dragon's aura": "Оберіть ауру дракона",
	"Set your dragon's secondary aura": "Оберіть другорядну ауру дракона",
	"Select an aura from those your dragon knows.": "Виберіть ауру, з тих, які знає ваш дракон.",
	"<b>One tenth</b> of every other dragon aura, <b>combined</b>.": "<b>Одна десята</b> ефекту кожної аури, <b>одночасно</b>.",
	"Switching your aura is <b>free</b> because you own no buildings.": "Зміна вашої аури <b>безкоштовна</b>, тому що у вас немає будівель",
	"The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!": "Ціна зміни активної аури <b>%1</b>.<br>Це вплине на ваші ПзС!",
	"Your dragon dropped something!": "Ваш дракон щось впустив!",
	"Breath of Milk": "Молочний подих",
	"Dragon Cursor": "Курсор Дракона",
	"Elder Battalion": "Армія Старійшин",
	"Reaper of Fields": "Жнивар Полів",
	"Earth Shatterer": "Руйнівник Земель",
	"Master of the Armory": "Майстер Обладунків",
	"Fierce Hoarder": "Запеклий Барахольник",
	"Dragon God": "Бог Драконів",
	"Arcane Aura": "Аура Аркани",
	"Dragonflight": "Політ Дракона",
	"Ancestral Metamorphosis": "Метаморфоза Пращурів",
	"Unholy Dominion": "Нечестиве Панування",
	"Epoch Manipulator": "Володар Часу",
	"Mind Over Matter": "Розум є, матерія не треба",
	"Radiant Appetite": "Блискучий Апетит",
	"Dragon's Fortune": "Удача Дракона",
	"Dragon's Curve": "Крива Дракона",
	"Reality Bending": "Згин Реальності",
	"Dragon Orbs": "Перлини Дракона",
	"Supreme Intellect": "Неперевершений Інтелект",
	"Dragon Guts": "Нутро Дракона",
	"News :": "Новини",
	"Ticker (grandma)": [
		"Вологе печиво.",
		"Ми добрі бабусі.",
		"Примусова праця.",
		"Ну ж бо, поцілуй бабусю.",
		"Чому ти так рідко мене навідуєш?",
		"Зателефонуй мені..."
	],
	"Ticker (threatening grandma)": [
		...
		"Ми сходимо.",
		"Це початок.",
		"Воно буде всюди, зовсім скоро.",
		"Ти міг це зупинити."
	],
	"Ticker (angry grandma)": [
		"Воно зрадило нас, бридка мала гнида.",
		"Воно намагалося нас здихатися, огидна мала гнида.",
		"Воно гадало, що ми просто зникнемо, продавши нас. Як мило.",
		"Я відчуваю запах твого гнилого печива."
	],
	...
	"Ticker (grandma invasion start)": [
		"мільйони літніх жінок раптово зникли!",
		"родини навколо континенту повідомляють про свою схвильованість, щодо перевтілених бабусь!",
		"медсестри повідомляють \"дивний запах тіста від печива\" навколо пацієнток похилого віку!"
	],
	"Ticker (grandma invasion rise)": [
		"cвавілля панує над містом, химерні бабусі вдираються в будинки, щоб викрасти немовлят та кухонне приладдя!",
		"весь континент переживає масову втечу бабусь !",
		"похилі жінки freeze in place in streets, та сочаться теплих солодким сиропом!" 
	],
	"Ticker (grandma invasion full)": [
		"зморщені \"м'ясні вусика\" видно з космосу!",
		"всі надії встрачено, зморшкувата маса плоті та тіста поглинає ціле місто!",
		"жахіття продовжується, зморшкуваті гектари плоті розростаються з неймовірною швидкістю!"
	],
	"Ticker (Farm)": [
		"печивові ферми викидають шкідливий шоколад у наші річки, повідомляє вченний!",
		"суперечки навколо генитично-модифікованого шоколаду беспокоять печивових фермерів!",
		"печиво з ферм вважається непридатним для веганів, повідомляє дієтолог."
	],
	"Ticker (Mine)": [
		"чи стає наша планета легшою? Експерти оцінюють наслідки інтенсивного викопу шоколаду.",
		"виявлено, що шоколадні шахти спричиняють землетруси та кастрові лійки!",
		"в глибинах шоколадних шахт розмістилися \"своєрідні, шоколадні істоти\"!"
	],
	"Ticker (Factory)": [
		"фабрики печива спричиняють глобальне потепління!",
		"печивові фабрики страйкують, через робо-посіпак, що замінюють робочу силу!",
		"печивові фабрики страйкують - працівники вимагають припинити платити їм печивом!"
	],
	"Ticker (Bank)": [
		"печивові позики зростають, люди більше неможуть дозволити собі їх за звичайні гроші.",
		"печиво повільно прокладає собі шлях як конкурент традиційній валюті!",
		"більшість пекарень встановили банкомати, щоб забезпечити просте поповнення та зняття печива."
	],
	"Ticker (Temple)": [
		"нещодавно знайдений шоколадний храм породжує новий культ пов'язанний з печивом; тисячі моляться Пекару в небі!",
		"віряни зі всього світу відкривають для себе нову релігію печива - \"Ой лихо, схоже, весь цей час ми помилялись!\"",
		"дослідники повернули стародавній артефакт з покинутого храму; archeologists marvel at the centuries-old rolling pin!"
	],
	"Ticker (Wizard tower)": [
		"потіште себе новими чарами та закляттями на щорічному Міжнародному Ярмарку Чаклунів! Знижені ціни на руни та книги заклять.", // Exclusive prices on runes and spellbooks
		"печивові чаклуни заперечують свою пречетність у народжені шокуючи потворного немовля. Дитина - \"чесно кажучи, виглядає бридко, але природньо\", повідомляють лікарі.",
		"\"Будь-яку достатньо грубу магію, неможливо відрізнити від технологій\", стверджує відомий техночаклун." //Any sufficiently crude magic is indistinguishable from technology
	],
	"Ticker (Shipment)": [
		"знайдено нову шоколадну планету, що стане новою мішеню для печивових торгових зорельотів!",
		"відкрито нову шоколадну планету-гігант, кора якої складається на 99.8% з чистого чорного шоколаду!",
		"організми з будовою на основі шоколаду було знайдено на далекій планеті!"
	],
	"Ticker (Alchemy lab)": [
		"національні золотовалютні резерви зменшуються, оскільки все більше і більше дорогоцінного матеріалу перетвоють у печиво!",
		"було знайдено, що срібло також можна трансформувати у білий шоколад!", // silver found to also be transmutable into white chocolate!
		"дефективну алхімічну лабораторію закрито, було виявлявлено сліди перетворення печива у непотрібне золото."
	],
	"Ticker (Portal)": [
		"людство стурбоване збільшенням кількості потворних створінь, що з'являються з просторових порталів!",
		"tourism to cookieverse popular with bored teenagers! Casualty rate as high as 73%!", // cookieverse? // поїздки до печивсесвіту популярні серед знудених підлітків! Рівень нещсаних випадків лишень 73%!
		"cookieverse portals suspected to cause fast aging and obsession with baking, says study." // ??? // є підозра, що портали до печивсесвіту викликають прискорене старіння та одержимість випічкою, показують дослідження
	],
	"Ticker (Time machine)": [
	...
	"Ticker (misc)": [
		"лікарі рекомендуюють двічі на день вживати свіже печиво.",
		"лікарі радять відмовитися від нової модної дієти без печива.",
		"лікарі попереджують матусь про небезпеку \"домашнього печива\".",
		"\"у мене немає залежності від печива. Це просто спекуляції моїх прихильників, котрі мають надто багато вільного часу\", повідомляє знаменитість.",
		"\"гаразд, я скажу цк - я ніколи не їв печива за все своє життя\", повідомляє знаменитість.",
		"\"печиво допомагає мені залишатися стрункою та здоровою\", повідомляє знаменитість.",
		"чоловік грабує банк, та купує печиво.",
		"нове дослідження припускає, що печиво не пришвудшує та не сповільнює старіння, натомість \"воно абсолютно змінює цей процес\".", // new study suggests cookies neither speed up nor slow down aging, but instead \"take you in a different direction\".
		"у чоловіка знайшли алергію до печива; \"ну й дивак\", повідомляє його сім'я.", //
		"місто вразив дефіцит печива, люди вимушені їсти кекси; \"зовсім не те\", визнає мер.",
		"\"ви повині визнати, вся ця історія з печивом якась зловісна\", повідомляє збентежений бовдур.",
		"дивне нелегальне печиво було конфісковано; \"на смак огидно\", повідомляє поліція.",
		"\"Ооук\", повідомляє опитанний орангутанг.",
		"невже наш медіа простір контролюється індустрією печива? Це цілком може бути правдою, повідомляє божевільний конспірологічний теоретик.",
		"\"наразі, печиво вже проникло у економіку\", повідомляє економіст. \"Якщо ми почнемо їсти що-небудь інше, ми всі помремо.\"",
		"печиво тепер незаконне у деяких відсталих країнах на яких всім начхати. Політична напруга зростає; скоро війна, сподіваємось."
	],
	...
	"Researched": "/",
	"Purchased": "Придбано",
	"Unlocked forever": "Розблоковано назавжди",
	"Click to learn!": "Клацніть, щоб вивчити!",
	"Click to unlearn!": "Клацніть, щоб відучитися!",
	"Upgrade": "/",
	"Upgrades": "/",
	"Achievement": "/",
	"Achievements": "/",
	...
	"all": "всі",
	"max": "макс",
	"Buy all upgrades": "Купити всі покращення",
	...
	"Wizard tower": "Вежа чакулна",
	"wizard tower": "вежа чаклуна",
	"wizard towers": "вежі чаклунів",
	"%1 wizard tower": [
		"%1 вежа чаклуна",
		"веж чаклунів: %1"
	],
	...
	"Current bonus:": "/",
	"Garden": "/",
	"Baker's wheat": "Пекарська пшениця",
	...
	"Thumbcorn": "Пальцевидна кукурудза",
	...
	"Ordinary clover": "Звичайна конюшина",
	...
	"White chocoroot": "Біле шокоріння",
	...
	"Juicy queenbeet": "Соковитий королівський буряк",
	...
	"[Achievement name 112]Oh deer": "Олені олені",
	...
	"[Achievement name 132]Tiny cookie": "Манюсіньке печивко",
	"[Achievement name 133]You win a cookie": "Тримай печивко",
	...
	"[Achievement name 241]Fast": "Швидко",
	...
	"[Achievement name 265]Eldeer": "Старолень",
